...
public class DdialogProgress extends Ddialog {
    private static final String FRAGMENT_TAG    = "DdialogProgress";

    private static final String ARG_MESSAGE     = "DdialogProgress_message";
    private static final String ARG_MAX_COUNT   = "DdialogProgress_max_count";
    private static final String ARG_COUNT       = "DdialogProgress_count";
    private static final String ARG_PROGRESS    = "DdialogProgress_progress";
    ...
    public DdialogProgress(int id) {
        this(id, null);
    }

    public DdialogProgress(int id, String callingfragmentTag) {
    ...
    private View onCreateView(LayoutInflater inflater,  Bundle savedInstanceState) {
        ...
        mProgressBar = (ProgressBar) view.findViewById(R.id.dialog_progress_bar);

        mMessageView = (TextView) view.findViewById(R.id.dialog_progress_message);
        if(mMessage != null) {
            mMessageView.setText(mMessage);
        } else {
            mMessageView.setVisibility(View.GONE);
        ...
        mCountView = (TextView) view.findViewById(R.id.dialog_progress_count);
        if(mMaxCount > 0) {
            _setCount();
        } else {
            mCountView.setVisibility(View.GONE);
        ...
        mPercentView = (TextView) view.findViewById(R.id.dialog_progress_percent);
        _setProgress();
